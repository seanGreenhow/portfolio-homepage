        ...
        return (
            <div id="background">
                <svg id="circuit-board" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <Wire animated stroke={variables.bigLineColor} width={variables.bigStrokeWidth} path={new Path()
                    ...
                    <Wire stroke={variables.smallLineColor} width={variables.smallStrokeWidth} path={new Path()
